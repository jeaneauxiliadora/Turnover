import pandas as pd
import numpy as np
from sklearn.naive_bayes import ComplementNB  # Alteração na importação
...
#    ("Classificador", GaussianNB(var_smoothing=1e-9)
#)
#])
...
metrics_df.to_csv('ML/result/metrics_nb.csv', index=False)
...
roc_data.to_csv('ML/result/roc_nb_data.csv', index=False)
