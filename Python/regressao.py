...
#    ("Classificador", LogisticRegression(solver='newton-cg', penalty='l2', max_iter=100, C=10,  random_state=123143)
#)
#])
...
metrics_df.to_csv('ML/result/metrics_lr.csv', index=False)
...
roc_data.to_csv('ML/result/metrics_lr.data.csv', index=False)
